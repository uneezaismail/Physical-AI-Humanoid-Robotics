...
links:
  ...
  ticket: {{LINKS_TICKET}}
  adr: history/adr/adr-005-docusaurus-frontend-styling-architecture.md
  pr: {{LINKS_PR}}
files:
  - history/adr/adr-005-docusaurus-frontend-styling-architecture.md
tests:
